...
const StartedHeader = () => {
  return (
    <div className='started-container'>
        ...
        <div className='started-img-padder'><Link to={'https://play.google.com/store/apps/details?id=com.textaify'} target="_blank"><img src={play} alt='Google Play Icon' width={162} height={63} className='started-img'/></Link></div>
