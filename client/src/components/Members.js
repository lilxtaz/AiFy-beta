...
const Members = (props) => {
  ...
  return (
    <div>
        ...
        <motion.div transition={{layout:{duration: 1, type: "spring"}}} layout onClick={()=>{setIsOpen(!isOpen);setDownBtn(!downBtn);}} style={{borderRadius: "1rem", boxShadow: "0px 10px 30px rgba(33, 38, 43, 0.2)", width: "40vh", display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding:'1.5rem 2rem 1.15rem 2rem' }} className='card'>
